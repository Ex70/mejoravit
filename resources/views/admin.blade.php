...
<head>
    ...
    <!-- My CSS -->
    @vite(['resources/css/style.css', 'resources/css/style.css', 'resources/js/script.js'])
            ...
            <div class="relative">
                ...
                <div id="dropdown-menu"
                    ...
                    <div class="p-4 border-b">
                        <p class="text-sm font-semibold">Miguel Jaimes</p>
                        <p class="text-xs text-gray-500">mjaimes@example.com</p>
                    </div>
                    ...
                    <div class="border-t">
                        <a href="#" class="block px-4 py-2 text-red-500 hover:bg-gray-100">Cerrar sesión</a>
                    </div>
                </div>
        </nav>
        <!-- NAVBAR -->
