...
{
    public function login(Request $reu){
    ...
    public function authenticate(Request $request){
        ...
        if (Auth::attempt(array_merge($credentials, ['state' => 'activo']))) {
    ...
    public function resetpass(Request $reu){
